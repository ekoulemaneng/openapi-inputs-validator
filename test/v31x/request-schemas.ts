...
import requestsSchemasGenerator from '../../src/v31x/request/schemas'
...
describe('requestsSchemasGenerator', async () => {
    context('should generate', async () => {
        it('an array of objects from the openapi spec 1',async () => {
            ...
            const expected = true
            // Exercise
            const indexes = requestsSchemasGenerator(JSON.parse(JSON.stringify(schemaResolved.result)) as OpenAPIv31x.OpenAPI)
            // Evaluate
